...
def create_sheets():
    ...
    try:
        ...
        print(
            f":warning: Error while trying to find the latest copyright datafile in {DATA_FOLDER}: {e}"
        )
        raise e
    ...
    try:
        ...
        print(
            f":warning: Error while trying to get the date of the latest copyright datafile: {e}"
        )
        raise e
    ...
    try:
        ...
        print(
            f':warning: Error while trying to create the export map {latest_file_date.strftime('%Y-%m-%d')} in folder sheets: {e}'
        )
        raise e
